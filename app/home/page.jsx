...
export default function LandingPage() {
  ...
  return (
    <main className="relative min-h-screen flex justify-center items-center text-center px-4 sm:px-6 overflow-hidden bg-white">
      <div className="absolute inset-0 flex justify-between items-center z-0 opacity-30">
        <div className="w-1/2">
          <LandingAnimation />
        </div>
        <div className="w-1/2">
      ...
      <div className="relative z-10 flex flex-col items-center max-w-4xl mx-auto">
        ...
        <div className="mt-12 sm:mt-16 flex justify-center">
          <button
            ...
            className="group flex items-center justify-center w-8 h-12 rounded-full border border-gray-300 text-gray-400 transition-all duration-300 hover:border-gray-500 hover:text-gray-600"
          >
            <svg
              className="w-4 h-4 transition-transform duration-300 group-hover:translate-y-1 animate-pulse"
              viewBox="0 0 24 24"
              fill="none"
              stroke="currentColor"
            >
